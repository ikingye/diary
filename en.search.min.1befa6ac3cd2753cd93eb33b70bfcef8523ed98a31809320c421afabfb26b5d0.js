...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/diary/flexsearch.min.js');loadScript('/diary/en.search-data.min.0368c57fbdddb0b8bdc2da45ed0aeb5a10e1797e1a3b771547338d3ab19aa7b7.js',function(){input.required=false;search();});}
