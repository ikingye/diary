...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/diary/flexsearch.min.js');loadScript('/diary/en.search-data.min.59f0dd74859b614cc31904489977571d568c239e5f856dadecac3b72455d6afe.js',function(){input.required=false;search();});}
