...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/diary/flexsearch.min.js');loadScript('/diary/en.search-data.min.5a58cd0e7fea5ae2b60f6f46f20a2cd27e7656fcf8c278236f91f6e29b6b8161.js',function(){input.required=false;search();});}
